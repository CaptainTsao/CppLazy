...
#ifndef _LAZY_TOOLS_HPP
#define _LAZY_TOOLS_HPP
...
assertionFail(const char *file, const int line, const char *func, const char *message) {
...
distance(const internal::CartesianProductIterator<Iterators...> &,
         const internal::CartesianProductIterator<Iterators...> &);
...
next(const internal::FlattenIterator<Iterator, N> &,
     internal::DiffType<internal::FlattenIterator<Iterator, N>> = 1);
